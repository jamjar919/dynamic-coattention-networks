...
for i in range(0, 7):
    ...
    with tf.Session(config=config) as sess:
        ...
        losses_outside.append(np.mean(losses))
        predicted_labels_outside.append(predicted_labels)
        score_50_list.append(score_50)
        ...
        with open(score50_file, append_write) as f:
            pickle.dump(score_50_list, f, protocol=3)
        ...
        with open(results_path + '/predicted_outputs.pkl', append_write) as f:
            pickle.dump(predicted_labels_outside, f, protocol=3)
        ...
        with open(results_path + '/test_losses.pkl', append_write) as f:
            pickle.dump(losses_outside, f, protocol=3) 
